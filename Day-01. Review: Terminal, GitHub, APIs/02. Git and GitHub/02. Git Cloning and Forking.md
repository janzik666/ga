...
We now need to connect our local Git repo with our remote repository on GitHub. We have to add a "remote" repository which is an address where we can send our local files to be stored.
